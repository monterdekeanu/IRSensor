...
void followLine() {
    unsigned char sensorState = PORTA & 0x07;
...
void followLineSimplified(){
    ...
    if((PORTDbits.RD0 == 1 && PORTDbits.RD2 == 1) && PORTDbits.RD1==0 ){
        PORTBbits.RB0 = 1;
        PORTBbits.RB1 = 1;
    }else if((PORTDbits.RD0==1) && (PORTDbits.RD2 == 0 && PORTDbits.RD1 == 0)){
        PORTBbits.RB0 = 0;
        PORTBbits.RB1 = 1;
    }else if((PORTDbits.RD2==1) && (PORTDbits.RD0 == 0 && PORTDbits.RD1 == 0)){
        PORTBbits.RB0 = 1;
        PORTBbits.RB1 = 0;
    }else{
        PORTBbits.RB0 = 0;
...
void followLineTwoSensor(){
    if(PORTDbits.RD0 == 0 && PORTDbits.RD2 == 0){
        PORTBbits.RB0 = 0;
        PORTBbits.RB1 = 0;
    }else if(PORTDbits.RD2 == 0 && PORTDbits.RD0 == 1){
        PORTBbits.RB0 = 1;
        PORTBbits.RB1 = 0;
    }else if(PORTDbits.RD2 == 1 && PORTDbits.RD0 == 0){
        PORTBbits.RB0 = 0;
        PORTBbits.RB1 = 1;
    }else if(PORTDbits.RD2 == 1 && PORTDbits.RD0 == 1){
        PORTBbits.RB0 = 1;
        PORTBbits.RB1=1;
    }
}
